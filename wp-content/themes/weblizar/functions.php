...
function weblizar_custom_admin_notice() {
	...
	<div class="our-product-features">	
		...
		<div class="col-md-12">
		<a class="dismiss" href="?-notice-dismissed<?php echo esc_attr($currentversion); ?>"><?php esc_html_e('Click here to dismiss This Ad.','weblizar');?></strong></a>
			...
			<div id="home" class="tab-pane fade in active">
					...
					<div class="col-md-4 theme-img">
						<div class="wb_products"> 
							<div class="wb_products-inner"> 
								...
								<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/Weblizar.jpg" class="img-responsive">  
								</a>
							</div>
						</div>
					</div>
				...
				<!--<h3>  <span> Review and Rating  </span></h3>-->
				  ...
				  <div class="notice-box notice-success is-dismissible flat_responsive_notice" data-dismissible="disable-done-notice-forever">
						<p>	
							<?php esc_html_e('Thank you for using the free version of ','weblizar'); ?>
							<?php echo esc_html( $wl_th_info->get('Name') );?> - 
							<?php echo esc_html( $wl_th_info->get('Version') );
							 ?>
							<?php esc_html_e('Please give your reviews and ratings on ','weblizar'); echo esc_attr($wl_th_info->get('Name')); esc_html_e(' theme. Your ratings will help us to improve our themes.', 'weblizar'); ?>
							<a class="rateme" href="<?php echo esc_url('https://wordpress.org/support/theme/weblizar/reviews/?filter=5');  ?>" target="_blank" aria-label="Dismiss the welcome panel"> 
								<p><span class="dashicons dashicons-star-filled"></span>
								<span class="dashicons dashicons-star-filled"></span>
								<span class="dashicons dashicons-star-filled"></span>
								<span class="dashicons dashicons-star-filled"></span>
								<span class="dashicons dashicons-star-filled"></span></p>
							</a>
						</p>
				</div>
				</div>
